...
public class PruebaFuncion5(Javier) {

    static PruebaFuncion5(Javier) funcion = null;
    ...
    @Test
    void testFuncion5_2() {
        assertEquals(0, Funcion5.Funcion5("Javier Melendez Carlos Garcia Carlos Villar Juan Jesus"));
    }
}